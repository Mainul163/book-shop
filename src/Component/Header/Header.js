...
const Header = () => {
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse " id="navbarNav">
      <ul className="navbar-nav ml-lg-auto nav-iteam">
        ...
        <li className="nav-item">
        <Link className="nav-link active" aria-current="page" to="/deals"> Deals </Link>
        </li>
        <li className="nav-item">
        <Link className="nav-link active" aria-current="page" className="btn btn-warning" to="/login"> Login </Link>
        </li>
      </ul>
    </div>
  </div>
